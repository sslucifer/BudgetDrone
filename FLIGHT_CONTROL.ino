...
float pid_p_gain_roll = 0.2;               //Gain setting for the roll P-controller1.3
float pid_i_gain_roll = 0.0;              //Gain setting for the roll I-controller0.04
float pid_d_gain_roll = 12.0;              //Gain setting for the roll D-controller18.0
...
float pid_p_gain_yaw = 3.0;                //Gain setting for the yaw P-controller. //4.0
float pid_i_gain_yaw = 0.02;               //Gain setting for the yaw I-controller. //0.02
float pid_d_gain_yaw = 0.0;                //Gain setting for the yaw D-controller.0.0
...
void loop(){
  ...
  //that the loop time is still 4000us. 
  //! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! !
